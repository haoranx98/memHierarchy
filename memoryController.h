...
protected:
    ...
    virtual ~MemController() {
        ...
        if( this->core_mem_access )
            delete this->core_mem_access;
    }
    ...
    void set_core_num(int32_t core_num){
        this->m_core_num = core_num;
    };

    int32_t get_core_num(){
        return this->m_core_num;
    };

    void set_core_mem_access(std::vector<vector<int>> *core_mem_access){
        this->core_mem_access = core_mem_access;
    };
